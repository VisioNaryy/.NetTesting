...
namespace TestNinja.Mocking
{
    public class HouseKeeperService
    {
        ...
        private readonly ISaveStatementHelper _saveStatementHelper;
        private readonly IEmailSender _emailSender;
        private readonly IXtraMessageBox _xtraMessageBox;

        public HouseKeeperService(IUnitOfWork unitOfWork, ISaveStatementHelper houseKeeperStorage, IEmailSender emailSender, IXtraMessageBox xtraMessageBox)
        {
            _unitOfWork = unitOfWork;
            _saveStatementHelper = houseKeeperStorage;
        ...
        public void SendStatementEmails(DateTime statementDate)
        {
            ...
            {
                if (housekeeper.Email == null || string.IsNullOrWhiteSpace(housekeeper.Email))
                    continue;

                var statementFilename = _saveStatementHelper.SaveStatement(housekeeper.Oid, housekeeper.FullName, statementDate);
